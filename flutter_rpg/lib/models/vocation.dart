enum Vocation {
  ...
  junkie(
    title: "Code Junkie",
    description: 'Uses code to infiltrate enemy defences.',
    weapon: 'React 99',
  ...
  ninja(
    title: "UX Ninja",
    description: 'Uses quick and stealthy visual attacks.',
  ...
  // Constructor
  const Vocation({required this.title, required this.description, required this.image, required this.weapon, required this.ability});
